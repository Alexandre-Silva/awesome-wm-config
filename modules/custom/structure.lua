...
function structure.manage_client(c, startup)
  ...
  c:connect_signal("property::maximized", function()
    print("client signal property::maximized")
    func.client_print_dbg(c)
  end)
...
function structure.init()
	...
	widgets.launcher = awful.widget.launcher({ image = beautiful.awesome_icon, menu = structure.main_menu })
	...
	awful.screen.connect_for_each_screen(function(s)
		...
		s.mytaglist = awful.widget.taglist(s, awful.widget.taglist.filter.all, widgets.taglist.buttons)

		-- Create a textbox showing current universal argument
		s.myuniarg = wibox.widget.textbox()

		-- Create a tasklist widget
		s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, widgets.tasklist.buttons)
