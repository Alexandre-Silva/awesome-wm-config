                ...
                items = {
                    ...
                    },
                    {
                        "add tag &after current one", function ()
                            clear_instance()
                            func.tag_add_after(t)
                        end
                    },
                    {
                        "add tag &before current one", function ()
                            clear_instance()
                            func.tag_add_before(t)
                        end
                    },
                    {
                    ...
                    },
                    {
                        "view &previous tag", function ()
                            clear_instance()
                            func.tag_view_prev(t)
                        end
                    },
                    {
                        "view &next tag", function ()
                            clear_instance()
                            func.tag_view_next(t)
                        end
                    },
                    {
                    ...
                    },
                    {
                        "move tag &forward", function ()
                            clear_instance()
                            func.tag_move_forward()
                        end
                    },
                    {
                        "move tag &backward", function ()
                            clear_instance()
                            func.tag_move_backward()
                        end
                    },
                    {
                        "--- screen ---", function ()
                    ...
                    },
                    {
                        "move tag to pre&vious window", function ()
                            clear_instance()
                            func.tag_move_screen_prev()
                        end
                    },
                    {
                        "move tag to ne&xt window", function ()
                            clear_instance()
                            func.tag_move_screen_next()
                        end
                    },
                }
            })
