...
binds.globalkeys = awful.util.table.join(
  ...
  awful.key({},         "Print",       function () awful.spawn("flameshot gui") end),      -- screenshot tool
  awful.key({ "Shift" },"Print",       function () awful.spawn("flameshot launcher") end), -- screenshot tool
  ...
  awful.key({ }, "F13",  function () awful.spawn("astt.bash clip") end),
  awful.key({ }, "F14",  function () awful.spawn("astt.bash write") end),
