...
custom.timer.change_wallpaper = gears.timer.start_new(custom.config.layout_save_period, function()
...
custom.timer.change_wallpaper = gears.timer.start_new(custom.config.wallpaper_change_interval, function()
...
awful.rules.rules = {
	...
	-- All clients will match this rule.
	{
		...
		callback = function(c)
      -- workaround for bug that is setting maximized to true
      --
...
custom.timer.change_wallpaper = gears.timer.start_new(1, function()
